...
var displayAppointments = (data) => {
    ...
    data.forEach(appointment => {
        ...
        div.innerHTML += `
            <div class="relative h-90 m-5 pb-5 bg-white md:w-80 shadow-lg border-t-4 border-[#009fbd] rounded-2xl grow-0 shrink-0 lg:basis-2/5 sm:1.5/5 md:2.5/5">
...
var fetchAppointments = async (skeletonStatus) => {
    ...
    fetch(`http://localhost:5253/api/Receptionist/GetTodayAppointmentDetails?limit=${itemsperpage}&skip=${skip}`, {
        ...
        if (error.message === 'Unauthorized Access!') {
            ...
            openModal('alertModal', "Information", error.message);
...
var displayDoctors = (data) => {
    ...
    data.forEach(doctor => {
        ...
        div.innerHTML += `
            <div class="relative h-90 m-5 bg-white shadow-lg rounded-lg border grow-0 shrink-0 lg:basis-2/5 sm:2/5 md:3/5">
                    <div class="p-6 mt-10 mx-auto">
                        <div class="relative mx-auto border-8 border-[#009fbd] rounded-full overflow-hidden doctorImageCard">
                            <img src="../../Assets/images/${doctor.name}.jpg" alt="doctorImage"
