...
var displayAppointments = (data) =>{
    console.log(data)
    if(document.getElementById("displayTodayInformation")){
        document.getElementById("displayTodayInformation").classList.add("none");
    }
    if(document.getElementById("displayUpcomingInformation")){
        document.getElementById("displayUpcomingInformation").classList.add("none");
    }
    if(document.getElementById("displayCompletedInformation")){
        document.getElementById("displayCompletedInformation").classList.add("none");
    }
    ...
    data.forEach(appointment => {
        ...
        if(appointment.appointmentMode.toLowerCase() === "online"){
        ...
        if(appointment.appointmentDate.split('T')[0] === today){
            todayAppointment.innerHTML+=`
                        <div class="relative h-90 m-5 pb-5 bg-white shadow-lg border-t-4 border-[#009fbd] rounded-2xl grow-0 shrink-0 lg:basis-2/5 sm:basis-2/5 md:basis-3/5">
                            ...
                            <div class="flex flex-row justify-center mx-auto mt-3 mb-2" style=width:20%>
                                <button type="button" class="w-full  py-2 px-4 my-1 bg-[#009fbd] font-bold rounded-lg text-[#f6f5f5] border-2 border-[#009fbd] hover:bg-[#f6f5f5] ${hideOrNot} hover:text-[#009fbd]" onclick="cancelAppointment('${appointment.appointmentId}')">Cancel</button>
                            </div>
                        </div> 
            `;
        }
            ...
            <div class="relative h-90 m-5 pb-5 bg-white shadow-lg border-t-4 border-[#e9c46a] rounded-2xl grow-0 shrink-0 lg:basis-2/5 sm:basis-1/5 md:basis-3/5">
                            <div class="grid grid-cols-2 mt-12">
                                <div class="pl-4 pr-0">
                                    <div class="grid grid-cols-3">
                                        <h4 class="font-bold text-lg">Id</h4>
                            ...
                            <div class="flex flex-row justify-center mx-auto mt-3 mb-2" style=width:20%>
                                <button type="button" class="w-full  py-2 px-4 my-1 bg-[#e9c46a] font-bold rounded-lg border-2 border-[#e9c46a] hover:bg-[#f6f5f5] ${hideOrNot} hover:text-[#e9c46a]" onclick="cancelAppointment('${appointment.appointmentId}')">Cancel</button>
                            </div>
                        </div>                      
            `;
        }
            ...
            completedAppointment.innerHTML+=`
                        <div class="relative h-90 m-5 pb-5 bg-white shadow-lg border-t-4 border-[#36ba98] rounded-2xl grow-0 shrink-0 lg:basis-2/5 sm:basis-1/5 md:basis-3/5" >
                            <div class="grid grid-cols-2 mt-12">
                                <div class="pl-4 pr-0">
                                    <div class="grid grid-cols-3">
                                        <h4 class="font-bold text-lg">Id</h4>
                            ...
                            <div class="flex flex-row justify-center mx-auto mt-3 mb-2" style=width:50%>
                                <button type="button" class="w-full  py-2 px-4 my-1 bg-[#36ba98] font-bold rounded-lg ${hideOrNot} text-[#f6f5f5]  border-2 border-[#36ba98] hover:bg-[#f6f5f5] hover:text-[#36ba98]" onclick="viewPrescription('${appointment.appointmentId}')">View Prescription</button>
                            </div>
                        </div>                        
            `;
        }
    });
    console.log(todayAppointment.children.length)
    console.log(upcomingAppointment.children.length)
    console.log(completedAppointment.children.length)
        if(todayAppointment.children.length === 0){
            todayAppointment.innerHTML=`
                <div id="displayTodayInformation" class="mt-5 p-5 mb-5 border-l-4 border-red-400 bg-red-100 rounded-lg shadow-lg w-50 sm:w-80">
                    <h1 class="font-semibold"><i class='bx bxs-bell-ring bx-lg text-red-500 mr-3'></i>&nbsp;No Appointments are available today! &nbsp;</h1>
                </div>
            `;
        }
        if(upcomingAppointment.children.length === 0){
            upcomingAppointment.innerHTML=`
                <div id="displayUpcomingInformation" class="mt-5 p-5 mb-5 border-l-4 border-red-400 bg-red-100 rounded-lg shadow-lg w-50 sm:w-80">
                    <h1 class="font-semibold"><i class='bx bxs-bell-ring bx-lg text-red-500 mr-3'></i>&nbsp;No Appointments are available! &nbsp;</h1>
                </div>
            `;
        }
        if(completedAppointment.children.length === 0){
            completedAppointment.innerHTML=`
                <div id="displayCompletedInformation" class="mt-5 p-5 mb-5 border-l-4 border-red-400 bg-red-100 rounded-lg shadow-lg w-50 sm:w-80">
                    <h1 class="font-semibold"><i class='bx bxs-bell-ring bx-lg text-red-500 mr-3'></i>&nbsp;No Appointments are available! &nbsp;</h1>
                </div>
            `;
        }
...
var getAllAppointments = (skeletonStatus) =>{
    ...
    .then(data => {
        ...
        if(!skeletonStatus && data.length === 0){
