...
namespace HospitalManagement.Services
{
    public class DoctorService : IDoctorService
    {
        ...
        public DoctorService(IRepository<int, Appointment> appointmentRepository, IRepository<int, User> userDetailsRepository, 
            ...
            IRepository<int, Medication> medicationRepository, IRepository<int, Doctor> doctorRepository, IRepositoryForCompositeKey<int, DateTime, DoctorAvailability> doctorAvailabilityRepository)
        {
        ...
        public async Task<List<DoctorAppointmentReturnDTO>> GetAllScheduledAppointments(int doctorid)
        {
            ...
            try
            {
                var appointmentList = appointments.Select( a =>
                {
                    ...
                    {
                        return new DoctorAppointmentReturnDTO(a.AppointmentId, a.AppointmentDate, a.Slot, a.PatientId, patient.Name, patient.Age, patient.ContactNo, a.Description, a.AppointmentType, a.AppointmentMode,a.MeetLink, a.AppointmentStatus, prescriptionStatus);
                    }
                    else
                    {
                        return new DoctorAppointmentReturnDTO(a.AppointmentId, a.AppointmentDate, a.Slot, a.PatientId, patient.Name, patient.Age, patient.ContactNo, a.Description, a.AppointmentType, a.AppointmentMode, a.AppointmentStatus, prescriptionStatus);
                    }
