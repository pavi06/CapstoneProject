...
namespace HospitalManagement.Models
{
    public class Appointment
    {
        ...
        public Appointment(DateTime appointmentDate, TimeOnly slot, int doctorId, string speciality, int patientId, string description, string appointmentStatus, string appointmentType, string appointmentMode, string meetLink)
        {
